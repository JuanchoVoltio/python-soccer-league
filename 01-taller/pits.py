...
print("El tiempo del mecanico 1 fue {0}s, el 2 fue {1}s, el 3 fue{2}s, el 4 fue{3}".format(time_crew_member_1, time_crew_member_2, time_crew_member_3, time_crew_member_4))
